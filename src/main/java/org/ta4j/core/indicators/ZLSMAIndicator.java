 ...
 * The offset is not implemented, because the SimpleLinearRegressionIndicator of ta4j-core does not support it. The
 * default value on TradingView is anyway zero.
 */
