...
/**
 * Bar Height Percentage Indicator. Get the difference in percentage between open and close or high and low in relation
 * to a given indicator, by default the close price.
 */
